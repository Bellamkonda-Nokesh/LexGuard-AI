...
const features = [
  ...
  { icon: Eye,        title: 'Inline Document Viewer',         description: 'View your original contract with colour-coded highlights showing exactly which sections are risky.', grad: 'linear-gradient(135deg,#ec4899,#f43f5e)' },
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{ background: feat.grad, boxShadow: '0 4px 12px rgba(99,102,241,0.2)' }}
                >
                  <Icon className="w-5 h-5 text-white" />
                </div>
                <h3 className="font-bold mb-2 text-sm sm:text-base" style={{ color: 'var(--text-primary)' }}>
                  {feat.title}
                </h3>
